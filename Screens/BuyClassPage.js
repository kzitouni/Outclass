  ...
  render() {
    ...
    return (<View style={{ marginTop: 15 }}>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <View style={{margin: 5, backgroundColor: 'rgba(240,240,240,1)', padding: 10, borderRadius: 10, justifyContent: 'flex-start', alignItems: 'flex-start', height:200, marginLeft:35, marginRight:35}}>   
...
<View
          ...
          <View
            ...
            <Text style={{color:'red', fontSize: 30, textAlign: 'center', marginTop:10, marginLeft:80, justifyContent: 'center', alignItems:'center'}}>Price: </Text>  
            </View>       
            <View>      
